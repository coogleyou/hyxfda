...
$(function(){ $("#mailing label").inFieldLabels(); }); /* Mailing List Labels */
$(function(){ $("#search label").inFieldLabels(); }); /* Search Labels */
$(function(){ $("#home-maillist label").inFieldLabels(); }); /* Search Labels */
