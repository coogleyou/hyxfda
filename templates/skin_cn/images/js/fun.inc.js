...
function navnow(dom,part2,part3){
	...
	var dl = li.next("http://www.bjsslh.com/templates/skin_cn/images/js/dd.sub");
		dl.hide();
		if(part2.next("http://www.bjsslh.com/templates/skin_cn/images/js/dd.sub").length>0)part2.next("http://www.bjsslh.com/templates/skin_cn/images/js/dd.sub").show();
		if(part3.length>0)part3.parent('http://www.bjsslh.com/templates/skin_cn/images/js/dd.sub').show();
		li.bind('click',function(){
			var fdl = $(this).next("http://www.bjsslh.com/templates/skin_cn/images/js/dd.sub");
			if(fdl.length>0){
